...
class PermuterTest extends Test {
    ...
    **/
    ...
    /**
        ...
        Examples in the tests all use *unique* array elements, and permutations will be considered distinct, based on original position, even with repeated elements. (i.e. `[1,1,1]` will still be considered to have 6 permutations, all `[1,1,1]`)
